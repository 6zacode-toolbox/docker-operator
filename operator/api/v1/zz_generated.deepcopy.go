...
func (in *DockerComposeRunnerStatus) DeepCopyInto(out *DockerComposeRunnerStatus) {
	*out = *in
	if in.ComposeStatus != nil {
		in, out := &in.ComposeStatus, &out.ComposeStatus
		*out = make([]ComposeStatus, len(*in))
		copy(*out, *in)
	}
}
...
func (in *DockerHostSpec) DeepCopyInto(out *DockerHostSpec) {
	*out = *in
	out.SSHConnection = in.SSHConnection
}
...
func (in *DockerHostStatus) DeepCopyInto(out *DockerHostStatus) {
	*out = *in
	...
	if in.AppConfigMap != nil {
		in, out := &in.AppConfigMap, &out.AppConfigMap
